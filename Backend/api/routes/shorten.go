...
import (
    ...
    "github.com/navansh03/shorten-url-fiber-redis/helpers"
)
...
func ShortenURL(c *fiber.Ctx) error {
    ...
    if err == redis.Nil {
        ...
        return c.Status(fiber.StatusInternalServerError).JSON(fiber.Map{"error": "cannot connect to rate limit DB"})
    } else {
